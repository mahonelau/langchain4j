...
@ToString
@EqualsAndHashCode
public class IsPrefix implements Filter {

    private final String key;
    private final Object comparisonValue;

    public IsPrefix(String key, Object comparisonValue) {
    ...
    public boolean test(Object object) {
        ...
        if (actualValue instanceof String && comparisonValue instanceof String) {
            return comparisonValue.toString().startsWith(actualValue.toString());
        }
